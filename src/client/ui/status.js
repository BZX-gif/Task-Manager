...
export const STATUS_STYLES = {
  success: { dot: '#57b28c', cell: 'rgba(87,178,140,0.8)', label: 'Counted', text: 'text-emerald-400' },
  progress: { dot: '#cf9f5f', cell: 'rgba(207,159,95,0.45)', label: 'Partial credit', text: 'text-amber-300' },
