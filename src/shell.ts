...
<aside id="sidebar" class="hidden lg:flex flex-col w-[248px] shrink-0 border-r border-white/5 px-4 py-6 gap-1">
<div class="flex items-center gap-3 px-2 mb-8"><div class="brand-mark"><i class="fa-solid fa-bolt text-white text-sm"></i></div><div><p class="font-display font-bold text-white text-sm leading-tight">Command Center</p><p class="text-[11px] text-slate-500 leading-tight">Personal workspace</p></div></div>
...
<div class="rounded-2xl bg-base-850 border border-white/5 p-3.5" id="streak-mini">
...
<div class="rounded-2xl bg-base-850 border border-white/5 p-3.5" id="focus-mini">
